...
local MainTab = Window:CreateTab("Haupt", 4483362458)
local VisualsTab = Window:CreateTab("Visuals", 4483362458)
local AimbotTab = Window:CreateTab("Aimbot", 4483362458)
local TeleportTab = Window:CreateTab("Teleportieren", 4483362458)

local MainSection = MainTab:CreateSection("ESP-Steuerungen")
...
local VisualsSection = VisualsTab:CreateSection("Visuelle Elemente")
...
local TeleportSection = TeleportTab:CreateSection("Teleport-Steuerelemente")

local BringPlayersToggle = TeleportTab:CreateToggle({
   Name = "Spieler mitbringen",
   CurrentValue = false,
...
local MouseAimbotSection = AimbotTab:CreateSection("Maus-Aimbot (Rechtsklick ge...")
...
local AimbotSettingsSection = AimbotTab:CreateSection("Aimbot-Einstellungen")
...
Rayfield:Notify({
   Title = "ESP + Aimbot geladen",
   Content = "Das verbesserte ESP-System mit Dual-AIMBOT-, Hitbox- und Teleport-Funktionali...",
   Duration = 3,
   Image = "eye"
})