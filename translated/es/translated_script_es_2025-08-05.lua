...
local HitboxSizeSlider = MainTab:CreateSlider({
   Name = "Tamaño de la caja de acceso",
   Range = {5, 50},
   Increment = 1,
   CurrentValue = 10,
   Flag = "HitboxSize",
...
local MouseAimbotSection = AimbotTab:CreateSection("Mouse Aimbot (Sostenga el c...")
...
local MouseAimDistanceSlider = AimbotTab:CreateSlider({
   Name = "Distancia del objetivo del ...",
   Range = {50, 1000},
   Increment = 10,
   CurrentValue = 300,
...
local AimbotSettingsSection = AimbotTab:CreateSection("Configuración de Aimbot")
...
Rayfield:Notify({
   Title = "ESP + Aimbot cargado",
   Content = "¡El sistema ESP mejorado con funciones duales de aimbot, hitbox y teletranspo...",
   Duration = 3,
   Image = "eye"
})