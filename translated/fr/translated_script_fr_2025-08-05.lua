...
local AimbotTab = Window:CreateTab("Aimateur", 4483362458)
...
local MouseAimbotSection = AimbotTab:CreateSection("Mouse Aimbot (Hold Droite C...")
...
local MouseAimSmoothingSlider = AimbotTab:CreateSlider({
   Name = "La souris vise à s'assouplir",
   Range = {1, 10},
   Increment = 0.1,
   CurrentValue = 1,
...
local MouseAimDistanceSlider = AimbotTab:CreateSlider({
   Name = "Distance de visée de la souris",
   Range = {50, 1000},
   Increment = 10,
   CurrentValue = 300,
...
local AimbotSettingsSection = AimbotTab:CreateSection("Paramètres de l' objectif")
...
Rayfield:Notify({
   Title = "ESP + Aimbot chargé",
   Content = "Système ESP amélioré avec double butbot, hitbox, et fonctionnalité de télépor...",
   Duration = 3,
   Image = "eye"
})