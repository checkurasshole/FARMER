...
local AimbotTab = Window:CreateTab("オートエイム", 4483362458)
...
local MouseAimbotSection = AimbotTab:CreateSection("マウスAimbot （右クリック長押し）")
...
local AimbotSettingsSection = AimbotTab:CreateSection("Aimbot設定")
...
Rayfield:Notify({
   Title = "ESP + Aimbotがロードされました",
   Content = "デュアルエイムボット、ヒットボックス、テレポート機能を備えた強化されたESPシステムが有効になりました！",
   Duration = 3,
   Image = "eye"
})